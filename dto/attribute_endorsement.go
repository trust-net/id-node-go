...
type AttributeEndorsement struct {
	...
	// (optional) a base64 encoded secret key, encrypted using identity owner's PublicSECP256K1 key
	SecretKey string `json:"secret_key"`
	// a base64 encoded attribute value as defined by each attribute, either as plain text,
	// or cipher text (if secret_key is present)
